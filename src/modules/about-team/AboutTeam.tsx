	...
	const specialThanks: TeamMember[] = [
		{
			...
			role: '',
			description: 'Сбор старых гос. цен автомобилей/информации по аксессуарам',
		},
		{
			name: 'Aleksandr_Maslojorov #3',
			role: '',
			description: 'Единственный и неповторимый модератор чата',
		},
		{
